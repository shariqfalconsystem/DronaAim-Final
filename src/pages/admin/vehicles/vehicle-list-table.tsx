              ...
              vehiclesInformation?.vehicles.map((vehicle: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    <StyledDataCell>{vehicle?.lookup_FleetInsurers?.[0]?.name || 'NA'}</StyledDataCell>
                    <StyledDataCell>{vehicle?.lookup_fleetcompanies?.[0]?.insuredId || 'NA'}</StyledDataCell>
                    <StyledDataCell>{vehicle?.lookup_fleetcompanies?.[0]?.lonestarId || 'NA'}</StyledDataCell>
                    <StyledDataCell>{vehicle?.lookup_fleetcompanies?.[0]?.name || 'NA'}</StyledDataCell>{' '}
                    <StyledDataCell>{vehicle?.vehicleId ? vehicle?.vehicleId : 'NA'}</StyledDataCell>
                    <StyledDataCell>
