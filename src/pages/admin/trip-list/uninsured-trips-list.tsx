              ...
              tripsInformation?.trips?.map((trip: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    <StyledDataCell>{trip.lookup_fleetcompanies?.[0]?.lonestarId || 'NA'}</StyledDataCell>
                    <StyledDataCell>
                      <Box
                        sx={{
                          display: 'flex',
                    ...
                    <StyledDataCell>
                      <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                        ...
                        {trip?.startAddress !== 'NA' && trip?.estimatedStartAddress && (
                    ...
                    <StyledDataCell width="5%">
                      <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                        ...
                        {trip?.endAddress !== 'NA' && trip?.estimatedEndAddress && (
...
export default UninsuredTripListTable;
